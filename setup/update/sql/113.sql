...
ALTER TABLE public.network_file_fulltext ADD CONSTRAINT network_file_fulltext_network_file_fk FOREIGN KEY (network_file_id) REFERENCES public.network_file(id) ON DELETE CASCADE ON UPDATE CASCADE;
