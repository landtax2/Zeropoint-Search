...
INSERT INTO public.config (setting,value,editable,description) VALUES
	 ...
	 ('AI_PROCESSING_CHAT_MAX_LENGTH','9000','1','This is used for GUI interactive chats.'),
...
INSERT INTO public.config (setting, value, description, editable) VALUES ('AI_PROCESSING_SUMMARY_LENGTH', '600', 'The max number of words of the summary generated by the AI processing.  This modifies the prompt to the LLM to limit the summary to the specified number of words.', '1');
INSERT INTO public.config (setting, value, description, editable) VALUES ('AI_PROCESSING_CONTEXT_WINDOW', '6000', 'The context window of the text processed by the AI processing. This is the number of tokens that the AI can process at once. Increase this relative to the size of the AI_PROCESSING_CHAT_MAX_LENGTH.', '1');
INSERT INTO public.config (setting, value, description) VALUES ('APP_VERSION', '1.0.0.0', 'The version of the application');
