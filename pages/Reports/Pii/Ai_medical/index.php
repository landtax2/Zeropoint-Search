<?php
$report_name = 'Security Report - Documents Containing an AI Match for Personal Medical Information';
...
<p class="mb-3">
    A list of all network files containing an AI match for personal medical information.
</p>
<br />
<div class="row">
    <div class="col-md-3">
