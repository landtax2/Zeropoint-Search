<?php
$report_name = 'Security Report - Documents Containing a Regex Matched SSN';
...
<p class="mb-3">
    A list of all network files containing a hard SSN. A hard SSN is one that has matched a narrow scoped regex.
</p>
<br />
<div class="row">
    <div class="col-md-3">
