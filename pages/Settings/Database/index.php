...
<div class="container-fluid">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-3">
            <div class="card h-100">
                <div class="card-header">
                    <h5 class="card-title mb-0">Database Time Zone</h5>
                </div>
                <div class="card-body d-flex flex-column justify-content-between">
                    <h2 class="mb-0">
                        <?php
                        $queryText = "SELECT current_setting('TIMEZONE') AS timezone";
                        $result = $common->query_to_sd_array($queryText, []);
                        echo $result['timezone'];
                        ?>
                    </h2>
                    <p class="text-muted mb-0">Timezone defined by the database</p>
                </div>
            </div>
        </div>
    </div>
